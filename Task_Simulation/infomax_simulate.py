"""
infomax_simulate.py
Performs a single realization of the infomax model for a specified task.
...
objective = sm.model.InfoMax(gamma)
...
ax.set_title('InfoMax State Likelihood Trajectory')
...
ax.set_title('InfoMax Action Time Series')
